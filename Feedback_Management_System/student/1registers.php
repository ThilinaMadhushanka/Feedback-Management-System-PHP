...
<body>
    <div class="wrapper">
        ...
        <form action="1logins.php" class="form-register"><br>
            <div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO student (username, password) VALUES ('$username', '$hashedPassword')";

        if ($con->query($sql) === TRUE) {
            echo "<script>alert('New record created successfully'); window.location.href='1studentFeedback.php';</script>";
        } else {
